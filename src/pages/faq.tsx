...
const getFaqText = (n : number) => {
	switch(n) {
		...
		case 6: return '<p>It is the responsibility of the administrator of the Staking Pool to fund it with "Harvest Unit" assets that will be held and available in the smart contract.</p>\
...
const getFaqTitle = (n : number) => {
	switch(n) {
		...
		case 4: return 'Is there any proof of my Deposit?'
		case 5: return 'How are rewards calculated?'
		case 6: return 'Who is providing the rewards?'
		case 7: return 'Is it open source?'
		case 8: return 'I can\'t see my new Deposit'
